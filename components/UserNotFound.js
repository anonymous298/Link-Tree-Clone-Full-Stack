...
export default function UserNotFound() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-[#1a254f] px-4">
      ...
      <div className="relative flex flex-col items-center justify-center w-full max-w-md p-10 rounded-2xl border-4 border-[#8c13ff] 
        ...
        <div className="absolute inset-0 bg-[#8c13ff] opacity-10 blur-3xl rounded-2xl"></div>

        {/* Content above spotlight */}
        <h1 className="relative text-[7rem] font-bold text-[#8c13ff] mb-4 z-10">404</h1>
        ...
        <Link
          href="/"
          className="relative z-10 px-6 py-3 rounded-xl bg-gradient-to-r from-[#8c13ff] to-white text-[#1a254f] font-semibold shadow-lg hover:scale-105 transition-transform duration-300"
        >
          Return to Homepage
        </Link>
      </div>
